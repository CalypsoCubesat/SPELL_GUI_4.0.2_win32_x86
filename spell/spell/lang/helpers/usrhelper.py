...
PACKAGE 
    spell.lang.helpers.usrhelper
FILE
    usrhelper.py
    
DESCRIPTION
    Helpers for user management wrapper functions. 
...
class UserLogin_Helper(WrapperHelper):
    ...
    def _doOperation(self, *args, **kargs ):
        ...
        result = REGISTRY['USER'].login( self.__usr, self.__pwd, self._config)
...
class UserLogout_Helper(WrapperHelper):
    ...
    def _doOperation(self, *args, **kargs ):
        ...
        result = REGISTRY['USER'].logout( self.__usr, self._config)
