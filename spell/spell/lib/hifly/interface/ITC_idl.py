...
# Start of module "ITC"
#
__name__ = "spell.lib.hifly.interface.ITC"
_0_ITC = omniORB.openModule("spell.lib.hifly.interface.ITC", r"ITC.idl")
_0_ITC__POA = omniORB.openModule("spell.lib.hifly.interface.ITC__POA", r"ITC.idl")
...
_0_ITC.HAS_FAILED_STAGES = 1048576
_0_ITC.HAS_PENDING_STAGES = 2097152
_0_ITC.HAS_IDLE_STAGES = 4194304
_0_ITC.HAS_UNVERIFIED_STAGES = 8388608
_0_ITC.HAS_UNKNOWN_STAGES = 16777216
_0_ITC.HAS_TIMEOUT_STAGES = 33554432
...
_0_ITC._d_CEVstageStatus  = omniORB.tcInternal.tv_octet
_0_ITC._ad_CEVstageStatus = (omniORB.tcInternal.tv_alias, CEVstageStatus._NP_RepositoryId, "CEVstageStatus", omniORB.tcInternal.tv_octet)
...
_0_ITC.PASSED = 4
_0_ITC.FAILED = 8
_0_ITC.UNVERIFIED = 16
_0_ITC.UNKNOWN = 32
_0_ITC.TIMEOUT = 64
_0_ITC.SUPERSEDED = 128
_0_ITC.NOT_APPLICABLE = 17
_0_ITC.NEVER_EXECUTED = 256
...
class CommandParam (omniORB.StructBase):
    ...
    def __init__(self, m_name, m_isEngValue, m_isDefault, m_unit, m_radix, m_value):
        self.m_name = m_name
        self.m_isEngValue = m_isEngValue
        self.m_isDefault = m_isDefault
        self.m_unit = m_unit
        self.m_radix = m_radix
        self.m_value = m_value

_0_ITC.CommandParam = CommandParam
_0_ITC._d_CommandParam  = (omniORB.tcInternal.tv_struct, CommandParam, CommandParam._NP_RepositoryId, "CommandParam", "m_name", (omniORB.tcInternal.tv_string,0), "m_isEngValue", omniORB.tcInternal.tv_boolean, "m_isDefault", omniORB.tcInternal.tv_boolean, "m_unit", (omniORB.tcInternal.tv_string,0), "m_radix", omniORB.typeMapping["IDL:IBASE/Radix:1.0"], "m_value", omniORB.typeMapping["IDL:IBASE/Variant:1.0"])
...
class CommandValue (omniORB.StructBase):
    ...
    def __init__(self, m_name, m_releaseTime, m_executionTime, m_lastUpdateTime, m_sourceName, m_sourceType, m_subsystem, m_requestId, m_sequenceName, m_flags, m_interlockType, m_interlockStage, m_staticPTVstatus, m_dynamicPTVstatus, m_cevStatus, m_verifyDetails, m_parameters, m_rawData, m_tcRequestID, m_tcPktDataIndex):
        self.m_name = m_name
...
# End of module "ITC"
#
__name__ = "spell.lib.hifly.interface.ITC_idl"

_exported_modules = ( "spell.lib.hifly.interface.ITC", )
