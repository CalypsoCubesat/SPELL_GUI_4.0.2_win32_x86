...
PACKAGE 
    spell.lib.adapter.verifier
FILE
    verifier.py
    
DESCRIPTION
    The verifier is in charge of performing TM verifications
...
class TmVerifierClass(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            if not result:
                reason = "Actual value: " + str(self.getActualValue())
            ...
            if result:
                self.__updateInfo("SUCCESS", False)
            else:
